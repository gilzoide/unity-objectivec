...
namespace Gilzoide.ObjectiveC
{
    public static unsafe class Runtime
    {
        ...
        [DllImport("__Internal")]
        public extern static Id objc_retain(Id obj);

        [DllImport("__Internal")]
        public extern static void objc_release(Id obj);

        [DllImport("__Internal")]
        public extern static Id objc_autorelease(Id obj);

        [DllImport("__Internal")]
        public extern static Id objc_retainAutorelease(Id value);
        ...
        [DllImport("__Internal")]
        public extern static void objc_storeStrong(ref Id obj, Id value);
